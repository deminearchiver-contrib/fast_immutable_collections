...
void main() {
  ...
  test("add", () {
    expect(
      () => ListSet.of([1, 10, 50, -2, 8, 10, -2, 20]).add(100),
  ...
  test("add", () {
    expect(
      () => ListSet.of([1, 10, 50, -2, 8, 10, -2, 20]).addAll([100, 1000]),
      throwsUnsupportedError,
    );
    expect(
      () => ListSet.of([1, 10, 50, -2, 8, 10, -2, 20]).addAll({100, 1000}),
  ...
  test("clear", () {
    expect(
      () => ListSet.of([1, 10, 50, -2, 8, 10, -2, 20]).clear(),
      throwsUnsupportedError,
    );
  });
  ...
  test("+", () {
    ...
    expect(ListSet.of(<int?>{null, 1, 3}) + ListSet.of({10, 11}), {
      null,
      1,
      3,
      10,
    ...
    expect(ListSet.of(<int?>{null, 1, 3}) + ListSet.of({null, 1}), {
      null,
      1,
      3,
    });
  ...
  test("asMap", () {
    ...
    expect(ListSet.of(["hel", "lo", "there"]).asMap(), {
      0: "hel",
      1: "lo",
      2: "there",
    });
  ...
  test("getRange", () {
    final ListSet<String> colors = ListSet.of([
      "red",
      "green",
      "blue",
      "orange",
  ...
  test("indexWhere", () {
    ...
    expect(
      listSet.indexWhere((String element) => true, listSet.length + 1),
      -1,
    );
  ...
  test("lastIndexWhere", () {
    ...
    expect(
      listSet.lastIndexWhere((String note) => note.startsWith("d"), -1),
      -1,
    );
  ...
  test("reversedView", () {
    expect(ListSet.of(["do", "re", "mi", "re"]).reversedView, [
      "mi",
      "re",
      "do",
    ]);
  ...
  test("remove", () {
    expect(
      () => ListSet.of([1, 10, 50, -2, 8, 10, -2, 20]).remove(10),
      throwsUnsupportedError,
    );
  });
  ...
  test("removeAll", () {
    expect(
      () => ListSet.of([1, 10, 50, -2, 8, 10, -2, 20]).removeAll([10, 50, 100]),
      throwsUnsupportedError,
    );
  });
  ...
  test("removeWhere", () {
    expect(
      () => ListSet.of([
        ...
        -2,
        20,
      ]).removeWhere((int value) => value > 10),
      throwsUnsupportedError,
    );
  });
  ...
  test("retainsAll", () {
    expect(
      () => ListSet.of([1, 10, 50, -2, 8, 10, -2, 20]).retainAll([10, 50, 100]),
      throwsUnsupportedError,
    );
  });
  ...
  test("retainWhere", () {
    expect(
      () => ListSet.of([
        ...
        -2,
        20,
      ]).retainWhere((int value) => value > 10),
      throwsUnsupportedError,
    );
  });
  ...
  test("[]=", () {
    expect(
      () => ListSet.of([1, 10, 50, -2, 8, 10, -2, 20])[3] = 1000,
      throwsUnsupportedError,
    );
  });
  ...
  test("fillRange", () {
    expect(
      () => ListSet.of([1, 10, 50, -2, 8, 10, -2, 20]).fillRange(1, 3, 1000),
      throwsUnsupportedError,
    );
  });
  ...
  test("first setter", () {
    expect(
      () => ListSet.of([1, 10, 50, -2, 8, 10, -2, 20]).first = 1000,
      throwsUnsupportedError,
    );
  });
  ...
  test("insert", () {
    expect(
      () => ListSet.of([1, 10, 50, -2, 8, 10, -2, 20]).insert(3, 1000),
      throwsUnsupportedError,
    );
  });
  ...
  test("insertAll", () {
    expect(
      () =>
          ListSet.of([1, 10, 50, -2, 8, 10, -2, 20]).insertAll(3, [1000, 100]),
      throwsUnsupportedError,
    );
    expect(
      () =>
  ...
  test("last setter", () {
    expect(
      () => ListSet.of([1, 10, 50, -2, 8, 10, -2, 20]).last = 1000,
      throwsUnsupportedError,
    );
  });
  ...
  test("length setter", () {
    expect(
      () => ListSet.of([1, 10, 50, -2, 8, 10, -2, 20]).length = 1000,
      throwsUnsupportedError,
    );
  });
  ...
  test("removeAt", () {
    expect(
      () => ListSet.of([1, 10, 50, -2, 8, 10, -2, 20]).removeAt(10),
      throwsUnsupportedError,
    );
  });
  ...
  test("removeLast", () {
    expect(
      () => ListSet.of([1, 10, 50, -2, 8, 10, -2, 20]).removeLast(),
      throwsUnsupportedError,
    );
  });
  ...
  test("removeRange", () {
    expect(
      () => ListSet.of([1, 10, 50, -2, 8, 10, -2, 20]).removeRange(1, 5),
      throwsUnsupportedError,
    );
  });
  ...
  test("setAll", () {
    expect(
      () => ListSet.of([1, 10, 50, -2, 8, 10, -2, 20]).setAll(5, [100, 1000]),
      throwsUnsupportedError,
    );
  });
