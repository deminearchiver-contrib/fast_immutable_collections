...
void main() {
  ...
  test("length", () {
    ...
    final ImmutableSet<int> iset = baseSet.lock;
    final ModifiableSetFromISet<int> modifiableSetView = ModifiableSetFromISet(
      iset,
    );
  ...
  test("lock", () {
    ...
    expect(modifiableSetView.lock, allOf(isA<ImmutableSet<int>>(), baseSet));
  });
