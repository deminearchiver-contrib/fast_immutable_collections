...
import 'package:fic/src/set/s_add_all.dart';
...
void main() {
  //
  test("Runtime Type", () {
    final ImmutableSetAddAllDelegate<int> sAddAll = ImmutableSetAddAllDelegate(
      ImmutableSetFlatDelegate<int>.unsafe({1, 2}),
      {3, 4, 5},
    );
    expect(sAddAll, isA<ImmutableSetAddAllDelegate<int>>());
  });
  ...
  test("length, first, last", () {
    final ImmutableSetAddAllDelegate<int> sAddAll = ImmutableSetAddAllDelegate(
      ImmutableSetFlatDelegate<int>.unsafe({3, 4}),
      {1, 2, 5},
    );
  ...
  test("unsafe", () {
    ...
    final ImmutableSetAddAllDelegate<int> sAddAll =
        ImmutableSetAddAllDelegate.unsafe(
          ImmutableSetFlatDelegate<int>.unsafe({1, 2}),
          set,
        );
  ...
  test("Combining various SAddAlls and SAdds | Runtime Type", () {
    final sAddAll = ImmutableSetAddAllDelegate(
      ImmutableSetAddAllDelegate(
        ImmutableSetAddAllDelegate(
          ImmutableSetAddDelegate(
            ImmutableSetAddAllDelegate(
              ImmutableSetFlatDelegate.unsafe({1, 2}),
              {3, 4},
            ),
            5,
          ),
  ...
  test("Ensuring Immutability", () {
    ...
    ImmutableSetAddAllDelegate<int?> sAddAll = ImmutableSetAddAllDelegate(
      ImmutableSetFlatDelegate<int>({1, 2}),
      original,
    );
    ...
    original = {3, 4, 5};
    sAddAll = ImmutableSetAddAllDelegate(
      ImmutableSetFlatDelegate<int>({1, 2}),
      original,
    );
    ...
    final ImmutableSetDelegate<int?> s1 = sAddAll.add(6);
    final ImmutableSetDelegate<int?> s2 = sAddAll.add(5);
    ...
    int willChange = 6;
    ImmutableSetDelegate<int?> s = sAddAll.add(willChange);
    ...
    // variable
    original = {3, 4, 5};
    final ImmutableSetAddAllDelegate<int> sAddAll1 = ImmutableSetAddAllDelegate(
          ImmutableSetFlatDelegate<int>({1, 2}),
          original,
        ),
        sAddAll2 = ImmutableSetAddAllDelegate(
          ImmutableSetFlatDelegate<int>({8, 9}),
          original,
        );
