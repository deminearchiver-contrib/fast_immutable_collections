...
void main() {
  //
  test("Runtime Type", () {
    final ImmutableListAddDelegate<int> lAdd = ImmutableListAddDelegate<int>(
      ImmutableListFlatDelegate<int>([1, 2, 3]),
      4,
    );
    expect(lAdd, isA<ImmutableListAddDelegate<int>>());
  });
  ...
  test("length, first, last, single", () {
    ...
    expect(
      ImmutableListAddDelegate<int>(
        ImmutableListFlatDelegate<int>([]),
        1,
      ).single,
      1,
    );
  ...
  test("Ensuring Immutability", () {
    ...
    ImmutableListFlatDelegate<int> lFlat = ImmutableListFlatDelegate(original);
    ImmutableListAddDelegate<int> lAdd = ImmutableListAddDelegate(lFlat, 3);
    ...
    lAdd = ImmutableListAddDelegate<int>(lFlat, 3);

    expect(lAdd, <int>[1, 2, 3]);

    ImmutableListDelegate<int?> l = lAdd.add(4);
    ...
    original = [1, 2];
    lFlat = ImmutableListFlatDelegate(original);
    lAdd = ImmutableListAddDelegate(lFlat, 3);
    ...
    original = [1, 2];
    lFlat = ImmutableListFlatDelegate(original);
    final ImmutableListAddDelegate<int> lAdd1 = ImmutableListAddDelegate<int>(
          lFlat,
          3,
        ),
        lAdd2 = ImmutableListAddDelegate<int>(lFlat, 4);
