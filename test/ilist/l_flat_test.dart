...
void main() {
  ...
  test("getFlushed", () {
    ...
    final ImmutableListFlatDelegate<int> lFlat = ImmutableListFlatDelegate(
      original,
    );
  ...
  test("Runtime Type", () {
    ...
    final ImmutableListFlatDelegate<int> lFlat = ImmutableListFlatDelegate<int>(
      original,
    );
    expect(lFlat, isA<ImmutableListFlatDelegate<int>>());
  });
  ...
  test("empty", () {
    final ImmutableListDelegate<int> empty = ImmutableListFlatDelegate.empty();
  ...
  test("deepListHashCode", () {
    ...
    expect(lFlat.deepListEquals(ImmutableListFlatDelegate<int>([])), isFalse);
    expect(
      lFlat.deepListEquals(ImmutableListFlatDelegate<int>(original)),
      isTrue,
    );
    expect(
      lFlat.deepListEquals(ImmutableListFlatDelegate<int>([1, 2, 3, 4])),
      isFalse,
    );
  });
  ...
  test("Ensuring Immutability", () {
    ...
    ImmutableListFlatDelegate<int> lFlat = ImmutableListFlatDelegate<int>(
      original,
    );
    ...
    original = [1, 2, 3];
    lFlat = ImmutableListFlatDelegate(original);

    expect(lFlat, <int>[1, 2, 3]);

    ImmutableListDelegate<int?> l = lFlat.add(4);
    ...
    original = [1, 2, 3];
    lFlat = ImmutableListFlatDelegate<int>(original);
    ...
    // variable
    original = [1, 2];
    final ImmutableListFlatDelegate<int> lFlat1 = ImmutableListFlatDelegate(
          original,
        ),
        lFlat2 = ImmutableListFlatDelegate(original);
  ...
  test("unsafe", () {
    final List<int> original = [1, 2, 3];
    final ImmutableListFlatDelegate<int> lFlat =
        ImmutableListFlatDelegate.unsafe(original);
  ...
  test("elementAt", () {
    ...
    ImmutableListFlatDelegate<int> lFlat = ImmutableListFlatDelegate([
      1,
      2,
      3,
      4,
    ...
    // 2) Range exceptions
    lFlat = ImmutableListFlatDelegate([1, 2, 3, 4, 5, 6]);
  ...
  test("join", () {
    ...
    expect(ImmutableListFlatDelegate(<int>[]).join(","), "");
    expect(ImmutableListFlatDelegate.empty().join(","), "");
  });
  ...
  test("map", () {
    ...
    expect(ImmutableListFlatDelegate([1, 2, 3]).map((int v) => v + 1), [
      2,
      3,
      4,
    ]);
  ...
  test("reduce", () {
    ...
    expect(
      ImmutableListFlatDelegate([5]).reduce((int p, int e) => p * (1 + e)),
      5,
    );
  ...
  test("singleWhere", () {
    ...
    // 2) State exception
    expect(
      () => lFlat.singleWhere((int v) => v < 4, orElse: () => 100),
      throwsStateError,
    );
  });
  ...
  test("whereType", () {
    expect((ImmutableListFlatDelegate(<num>[1, 2, 1.5]).whereType<double>()), [
      1.5,
    ]);
  });
}
